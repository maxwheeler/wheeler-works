---
title: "Tiddle"
description: "Tiddle is a free daily word game for your browser — a bite-sized puzzle in the spirit of Wordle, but played on a board. Everyone gets the same 5×5 grid and rack of tiles each day: spell words, build on the ones already down, and land letters on bonus squares to beat the day's target score for a bronze, silver, or gold medal. Then compare on the leaderboard, watch replays of the best games, and share your result with a link — no download, no sign-up."
